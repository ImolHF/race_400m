...
gym.register(
    id="Template-Race-400m-RobustPhysics",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": f"{__name__}.race_400m_env_cfg:RobustPhysicsRaceEnvCfg", "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:RobustPhysicsPPORunnerCfg"},
)
