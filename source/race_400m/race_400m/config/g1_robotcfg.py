...
G1_CONFIG = ArticulationCfg(
    ...
    actuators={
        "left_leg": ImplicitActuatorCfg(
            ...
            stiffness={
                "left_hip_yaw_joint": 240.0,
                "left_hip_roll_joint": 240.0,
                "left_hip_pitch_joint": 300.0,
                "left_knee_joint": 300.0,
                "left_ankle_pitch_joint": 180.0,
                "left_ankle_roll_joint": 180.0,
            },
            damping={
        ...
        "right_leg": ImplicitActuatorCfg(
            ...
            velocity_limit_sim=50.0,
            stiffness={
                "right_hip_yaw_joint": 240.0,
                "right_hip_roll_joint": 240.0,
                "right_hip_pitch_joint": 300.0,
                "right_knee_joint": 300.0,
                "right_ankle_pitch_joint": 180.0,
                "right_ankle_roll_joint": 180.0,
            },
            damping={
